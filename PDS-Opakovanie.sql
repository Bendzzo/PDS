...
--Vytvorte poh¾ad, ktorý bude obsahova osoby a ich prislúchajúce poistenie (aj ak žiadne nemajú).
...
--Vytvorte poh¾ad, ktorý bude obsahova mestá a poèet osôb s trvalým pobytom.
...
--Vytvorte poh¾ad, ktorý bude obsahova zamestnancov a ich zamestnávate¾ov s dátumom zaèiatku pracovného pomeru.
...
--Vytvorte poh¾ad, ktorý bude obsahova poistencov spolu s poètom ich odvodových platieb.
...
--5. Vytvorte poh¾ad, ktorý bude obsahova osoby a typ ich postihnutia (ak existuje).
...
--6. Vytvorte poh¾ad, ktorý bude obsahova zamestnávate¾ov a poèet ich aktívnych zamestnancov.
...
--7. Vytvorte poh¾ad, ktorý bude obsahova osoby, ktoré sú zároveò poistencami aj zamestnancami.
...
--8. Vytvorte poh¾ad, ktorý bude obsahova typy príspevkov a poèet osôb, ktoré ich poberajú.
...
--9. Vytvorte poh¾ad, ktorý bude obsahova poistencov a dátum ich poslednej platby.
